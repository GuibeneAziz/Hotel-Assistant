const it: Record<string, string> = {
  ...
  voiceOutputOn: 'Voce attiva',
  voiceOutputOff: 'Voce disattivata',
  voiceStop: 'Ferma',
  voiceErrorPermission: "L'accesso al microfono è bloccato. Consenti il microfono nel browser e riprova.",
  voiceErrorNoSpeech: 'Nessun parlato rilevato. Riprova a parlare.',
  voiceErrorNetwork: 'Il riconoscimento vocale richiede una connessione a internet. Controlla la rete.',
  voiceErrorGeneric: "L'input vocale non è disponibile al momento. Riprova o scrivi il messaggio.",
  ...
  heroEyebrow: 'Il Futuro dell\'Ospitalità',
  heroHeading1: 'Scopri',
  heroHeading2: 'Un Lusso Senza Pari',
  heroSub: 'Scopri un mondo dove l\'eleganza senza tempo incontra l\'intelligenza moderna. Il nostro concierge IA personalizzato anticipa ogni desiderio per un soggiorno perfetto.',
  heroCtaPrimary: 'Esplora i nostri Hotel',
  heroCtaSecondary: 'Scopri di più',
  collectionEyebrow: 'Proprietà eccezionali selezionate per il viaggiatore esigente.',
  collectionTitle: 'La Collezione',
  navHotels: 'Hotel',
  navFeatures: 'Funzionalità',
  cardCTA: 'Chatta con l\'Assistente',
  'hotel_sindbad-hammamet_tagline': 'Fuga Balneare',
  'hotel_villa-didon-carthage_tagline': 'Perfezione Boutique',
  'hotel_belvedere-fourati-tunis_tagline': 'Rifugio Urbano',
  featuresEyebrow: 'Cosa offre la nostra piattaforma',
  featuresTitle: 'Funzionalità Smart',
  feature1Title: 'Concierge IA',
  feature1Body: 'Il nostro assistente intelligente anticipa ogni esigenza — dalle prenotazioni ai ristoranti alle scoperte locali — disponibile 24/7 in sei lingue.',
  feature2Title: 'Gestione Alberghiera in Tempo Reale',
  feature2Body: 'Il personale può aggiornare istantaneamente servizi, orari e informazioni tramite un cruscotto centralizzato.',
  feature3Title: 'Esperienza Ospite Senza Interruzioni',
  feature3Body: 'Dal check-in al check-out, ogni interazione è ottimizzata affinché gli ospiti si godano il soggiorno.',
  footerBrandSub: 'La migliore collezione alberghiera della Tunisia',
}
export default it
